package com.mutool.app;

import com.mutool.app.fxmlview.IndexView;
import com.mutool.app.utils.StageUtils;
...
@Slf4j
@SpringBootApplication(scanBasePackages = {"com.mutool.app"})
public class MutoolAppApplication extends AbstractJavaFxApplicationSupport {
    ...
    public static void main(String[] args) {
        try {
            ...
            launch(MutoolAppApplication.class, IndexView.class, splashScreen, args);
