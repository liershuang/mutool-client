...
<div class="layui-form layui-form-pane" style="padding-top:10px; float:right;">
    <div class="layui-form-item">
        <div class="layui-input-inline">
            <input type="text" id="searchKeyWord" name="username" lay-verify="required" placeholder="请输入"
                ...
                <div class="layui-col-md3">
                    <div class="layui-card">
                        <div class="layui-card-header" style="height: 80px;">
                            ...
                            <i class="layui-icon layui-icon-tips" style="font-size: 23px; color: #FFB800; float:right;"
                               onclick="showIntroduce('${plugin.synopsis}')"></i>
                            <br/>
                            <#if plugin.isDownload>
                                <button type="button" class="layui-btn layui-btn-xs layui-btn-disabled">下载</button>
                                <button type="button" class="layui-btn layui-btn-xs"
                                        onclick="deletePlugin('${plugin.jarName}')">更新
                                </button>
                                <button type="button" class="layui-btn layui-btn-xs"
                                        onclick="deletePlugin('${plugin.jarName}')">删除
                                </button>
                            <#else>
                                <button type="button" class="layui-btn layui-btn-xs"
                                        onclick="downloadPlugin('${plugin.jarName}')">下载
                                </button>
